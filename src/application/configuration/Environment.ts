...
export class Environment {
  ...
  subscriptionPublicSecretKey: string;
  constructor() {
    ...
    this.subscriptionPublicKey =
      env.VUE_APP_SUBSCRIPTION_PUBLIC_KEY?.toString() || "";
    this.subscriptionPublicSecretKey =
      env.VUE_APP_SUBSCRIPTION_SECRET_KEY?.toString() || "";
