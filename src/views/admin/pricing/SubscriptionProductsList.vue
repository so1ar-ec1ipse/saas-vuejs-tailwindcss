  ...
  <div>
    ...
    >
      <template v-slot:extraButtons>
        <span class="hidden sm:block shadow-sm rounded-sm mr-0">
          <router-link
            to="/pricing"
            target="_blank"
            class="h-8 inline-flex items-center px-4 py-2 border border-gray-300 text-xs leading-5 font-medium rounded-sm text-gray-700 bg-yellow-100 hover:text-gray-500 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 active:text-theme-900 active:bg-gray-50 active:text-theme-900 transition duration-150 ease-in-out"
          >
