          ...
          <div class="grid grid-cols-6 gap-2">
            ...
            >
              <label
                ...
                >{{ $t("models.subscriptionProduct." + column.name) }}</label
              >
...
export default class SubscriptionProductOverviewComponent extends BaseComponent {
  columns = [
